...
class PublicSubjectsController extends Controller
{
    ...
    public function index()
    {
        ...
        $publicSubjects = PublicSubject::with(['subject_category', 'media'])->get();
    ...
    public function create()
    {
        ...
        $subject_categories = SubjectsCategory::pluck('name', 'id')->prepend(trans('global.pleaseSelect'), '');

        return view('admin.publicSubjects.create', compact('subject_categories'));
    }
    ...
    public function edit(PublicSubject $publicSubject)
    {
        ...
        $publicSubject->load('subject_category');

        return view('admin.publicSubjects.edit', compact('publicSubject', 'subject_categories'));
    }
    ...
    public function show(PublicSubject $publicSubject)
    {
        ...
        $publicSubject->load('subject_category', 'postComments');
