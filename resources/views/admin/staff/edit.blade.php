    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.staff.update", [$staff->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="photo">{{ trans('cruds.staff.fields.photo') }}</label>
            ...
            <div class="form-group">
                <label class="required" for="job_tilte">{{ trans('cruds.staff.fields.job_tilte') }}</label>
                <input class="form-control {{ $errors->has('job_tilte') ? 'is-invalid' : '' }}" type="text" name="job_tilte" id="job_tilte" value="{{ old('job_tilte', $staff->job_tilte) }}" required>
                @if($errors->has('job_tilte'))
                    <div class="invalid-feedback">
                        {{ $errors->first('job_tilte') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.staff.fields.job_tilte_helper') }}</span>
            </div>
            <div class="form-group">
